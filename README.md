...
- [hopinc/js](https://github.com/hopinc/js) ([v1.44.2](https://github.com/hopinc/js/releases/tag/v1.44.2), 6 days ago) - 📝 Hop server side client library in JavaScript for Node.js
- [onRuntime/kartrak](https://github.com/onRuntime/kartrak) ([v0.0.6](https://github.com/onRuntime/kartrak/releases/tag/v0.0.6), 1 week ago) - Le suivi d&#39;activité tourné vers l&#39;écologie.
- [tonightpass/tonightpass](https://github.com/tonightpass/tonightpass) ([@tonightpass/requester@1.1.1](https://github.com/tonightpass/tonightpass/releases/tag/%40tonightpass/requester%401.1.1), 1 week ago) - @tonightpass sdk and tools.
...
- [Antoinekm/fix passed props](https://github.com/tonightpass/kitchen/pull/294) on [tonightpass/kitchen](https://github.com/tonightpass/kitchen) (2 months ago)
...
- [docs: add cards in docs theme build ins](https://github.com/shuding/nextra/pull/1942) on [shuding/nextra](https://github.com/shuding/nextra) (5 months ago)
...
- [eylonmiz/react-agent](https://github.com/eylonmiz/react-agent) - The open-source React.js Autonomous LLM Agent (4 days ago)
- [sadmann7/shadcn-table](https://github.com/sadmann7/shadcn-table) - Shadcn table component with server-side sorting, filtering, and pagination. (4 days ago)
- [vercel/style-guide](https://github.com/vercel/style-guide) - Vercel&#39;s engineering style guide (5 days ago)
- [Mobilecn-UI/nativecn-ui](https://github.com/Mobilecn-UI/nativecn-ui) - Beautiful and customizable React Native components (6 days ago)
- [onRuntime/kartrak](https://github.com/onRuntime/kartrak) - Le suivi d&#39;activité tourné vers l&#39;écologie. (1 week ago)
- [JakePartusch/psi-action](https://github.com/JakePartusch/psi-action) - A GitHub action that utilizes Google&#39;s Page Speed Insights to generate a performance report (2 weeks ago)
- [mickasmt/next-saas-stripe-starter](https://github.com/mickasmt/next-saas-stripe-starter) - An open-source SaaS Starter built using Next.js 14, Prisma, Planetscale, Auth.js, Resend, React Email, Shadcn/ui, Stripe and Server Actions. (2 weeks ago)
