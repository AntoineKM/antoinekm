...
- [shuding/nextra](https://github.com/shuding/nextra) ([nextra-theme-docs@2.13.0](https://github.com/shuding/nextra/releases/tag/nextra-theme-docs%402.13.0), 1 day ago) - Simple, powerful and flexible site generation framework with everything you love from Next.js.
- [vercel/turbo](https://github.com/vercel/turbo) ([v1.10.15-canary.0](https://github.com/vercel/turbo/releases/tag/v1.10.15-canary.0), 3 days ago) - Incremental bundler and build system optimized for JavaScript and TypeScript, written in Rust – including Turbopack and Turborepo.
...
- [TrevorSundberg/puppeteer-in-electron](https://github.com/TrevorSundberg/puppeteer-in-electron) - Use puppeteer to test and control your electron application. (3 days ago)
...
- [citizenfx/fivem](https://github.com/citizenfx/fivem) - The source code for the Cfx.re modification frameworks, such as FiveM, RedM and LibertyM, as well as FXServer. (3 months ago)
