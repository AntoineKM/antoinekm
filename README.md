...
- [eylonmiz/react-agent](https://github.com/eylonmiz/react-agent) - The open-source React.js Autonomous LLM Agent (5 days ago)
- [sadmann7/shadcn-table](https://github.com/sadmann7/shadcn-table) - Shadcn table component with server-side sorting, filtering, and pagination. (5 days ago)
- [vercel/style-guide](https://github.com/vercel/style-guide) - Vercel&#39;s engineering style guide (6 days ago)
- [Mobilecn-UI/nativecn-ui](https://github.com/Mobilecn-UI/nativecn-ui) - Beautiful and customizable React Native components (1 week ago)
