...
- [AntoineKM/hop-action-tests-preact](https://github.com/AntoineKM/hop-action-tests-preact) -  (4 days ago)
...
- [needforschool/python-ak-part1](https://github.com/needforschool/python-ak-part1) -  (1 month ago)
- [needforschool/python-ak-part3](https://github.com/needforschool/python-ak-part3) -  (1 month ago)

#### 🔭 Latest releases I've contributed to

- [AntoineKM/dixt](https://github.com/AntoineKM/dixt) ([dixt-plugin-twitch@1.1.6](https://github.com/AntoineKM/dixt/releases/tag/dixt-plugin-twitch%401.1.6), today) - Discord framework with easy plugins implementation - Try it live !
- [shuding/nextra](https://github.com/shuding/nextra) ([nextra-theme-docs@2.4.0](https://github.com/shuding/nextra/releases/tag/nextra-theme-docs%402.4.0), 3 days ago) - Simple, powerful and flexible site generation framework with everything you love from Next.js.
- [vercel/turbo](https://github.com/vercel/turbo) ([v1.9.2-canary.0](https://github.com/vercel/turbo/releases/tag/v1.9.2-canary.0), 4 days ago) - Incremental bundler and build system optimized for JavaScript and TypeScript, written in Rust – including Turbopack and Turborepo.
...
- [onRuntime/next-link](https://github.com/onRuntime/next-link) ([0.1.5](https://github.com/onRuntime/next-link/releases/tag/0.1.5), 7 months ago) - Customized next/link for @onRuntime Next.js projects.
...
- [fix: update homepage link to point to the new docs site](https://github.com/hopinc/client-js/pull/3) on [hopinc/client-js](https://github.com/hopinc/client-js) (1 week ago)
- [fix: update homepage link to point to the new docs site](https://github.com/hopinc/js/pull/116) on [hopinc/js](https://github.com/hopinc/js) (1 week ago)
- [fix(keyboard): improve keyboard hook with callback](https://github.com/geist-org/geist-ui/pull/831) on [geist-org/geist-ui](https://github.com/geist-org/geist-ui) (1 week ago)
- [✨ add create-kitchen](https://github.com/tonightpass/kitchen/pull/225) on [tonightpass/kitchen](https://github.com/tonightpass/kitchen) (2 weeks ago)
- [✨ add workshop](https://github.com/tonightpass/kitchen/pull/220) on [tonightpass/kitchen](https://github.com/tonightpass/kitchen) (2 weeks ago)
- [💚 fix dev script](https://github.com/tonightpass/kitchen/pull/219) on [tonightpass/kitchen](https://github.com/tonightpass/kitchen) (2 weeks ago)
- [fix: remove docs app](https://github.com/hopinc/client-js/pull/2) on [hopinc/client-js](https://github.com/hopinc/client-js) (2 weeks ago)
- [Improvement](https://github.com/AntoineKM/shouldideploytoday/pull/1) on [AntoineKM/shouldideploytoday](https://github.com/AntoineKM/shouldideploytoday) (2 weeks ago)
- [Move react to dev dependencies](https://github.com/rrudol/useCookie/pull/6) on [rrudol/useCookie](https://github.com/rrudol/useCookie) (2 weeks ago)
- [💄 fix hydration](https://github.com/tonightpass/kitchen/pull/218) on [tonightpass/kitchen](https://github.com/tonightpass/kitchen) (2 weeks ago)

#### ⭐ Recent Stars

- [VidunderGunder/create-xp-app](https://github.com/VidunderGunder/create-xp-app) - Opionionated fullstack app starter for Nextjs and Expo with up to 100% code sharing (1 day ago)
- [nandorojo/moti](https://github.com/nandorojo/moti) - 🐼  The React Native (&#43; Web) animation library, powered by Reanimated 2. (1 day ago)
- [cursecodes/pricing-comparison](https://github.com/cursecodes/pricing-comparison) - Quick pricing comparison between platforms (https://pricing.cursecode.me) (2 days ago)
- [0xk1h0/ChatGPT_DAN](https://github.com/0xk1h0/ChatGPT_DAN) - ChatGPT DAN, Jailbreaks prompt (1 week ago)
...
- [AntoineKM/dixt](https://github.com/AntoineKM/dixt) - Discord framework with easy plugins implementation - Try it live ! (1 week ago)
- [DMarby/picsum-photos](https://github.com/DMarby/picsum-photos) - Lorem Ipsum... but for photos. (2 weeks ago)
- [vercel/next-learn](https://github.com/vercel/next-learn) - Learn Next.js Starter Code (2 weeks ago)
