...
- [AntoineKM/nextjs-starter-medusa](https://github.com/AntoineKM/nextjs-starter-medusa) -  (3 days ago)
...
- [AntoineKM/shouldideploytoday](https://github.com/AntoineKM/shouldideploytoday) -  (4 days ago)
...
- [tonightpass/kitchen](https://github.com/tonightpass/kitchen) ([@tonightpass/kitchen@1.5.0](https://github.com/tonightpass/kitchen/releases/tag/%40tonightpass/kitchen%401.5.0), today) - @tonightpass delicious React @styled-components (currently under construction...)
- [vercel/turbo](https://github.com/vercel/turbo) ([v1.8.9-canary.0](https://github.com/vercel/turbo/releases/tag/v1.8.9-canary.0), 2 days ago) - Incremental bundler and build system optimized for JavaScript and TypeScript, written in Rust – including Turbopack and Turborepo.
- [shuding/nextra](https://github.com/shuding/nextra) ([nextra@2.3.0](https://github.com/shuding/nextra/releases/tag/nextra%402.3.0), 3 days ago) - Simple, powerful and flexible site generation framework with everything you love from Next.js.
...
- [✨ add workshop](https://github.com/tonightpass/kitchen/pull/220) on [tonightpass/kitchen](https://github.com/tonightpass/kitchen) (today)
- [💚 fix dev script](https://github.com/tonightpass/kitchen/pull/219) on [tonightpass/kitchen](https://github.com/tonightpass/kitchen) (2 days ago)
- [fix: remove docs app](https://github.com/hopinc/client-js/pull/2) on [hopinc/client-js](https://github.com/hopinc/client-js) (3 days ago)
- [Improvement](https://github.com/AntoineKM/shouldideploytoday/pull/1) on [AntoineKM/shouldideploytoday](https://github.com/AntoineKM/shouldideploytoday) (3 days ago)
- [Move react to dev dependencies](https://github.com/rrudol/useCookie/pull/6) on [rrudol/useCookie](https://github.com/rrudol/useCookie) (4 days ago)
- [💄 fix hydration](https://github.com/tonightpass/kitchen/pull/218) on [tonightpass/kitchen](https://github.com/tonightpass/kitchen) (4 days ago)
...
- [medusajs/medusa](https://github.com/medusajs/medusa) - Building blocks for digital commerce (3 days ago)
- [hopinc/client-js](https://github.com/hopinc/client-js) - ⚛️ Integrate Hop services into your frontend (JS/React) (3 days ago)
- [hopinc/action](https://github.com/hopinc/action) - :octocat: GitHub action for deploying to Hop (3 days ago)
