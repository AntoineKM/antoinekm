...
- [shuding/nextra](https://github.com/shuding/nextra) ([nextra-theme-blog@2.4.1](https://github.com/shuding/nextra/releases/tag/nextra-theme-blog%402.4.1), 1 day ago) - Simple, powerful and flexible site generation framework with everything you love from Next.js.
- [AntoineKM/dixt](https://github.com/AntoineKM/dixt) ([dixt-plugin-presence@1.0.1](https://github.com/AntoineKM/dixt/releases/tag/dixt-plugin-presence%401.0.1), 2 days ago) - Discord framework with easy plugins implementation - Try it live !
- [vercel/turbo](https://github.com/vercel/turbo) ([v1.9.4-canary.2](https://github.com/vercel/turbo/releases/tag/v1.9.4-canary.2), 2 days ago) - Incremental bundler and build system optimized for JavaScript and TypeScript, written in Rust – including Turbopack and Turborepo.
...
- [peterw/Gumroad-Landing-Page-Generator](https://github.com/peterw/Gumroad-Landing-Page-Generator) -  (1 day ago)
- [Thinkmill/manypkg](https://github.com/Thinkmill/manypkg) - ☔️ An umbrella for your monorepo (5 days ago)
