...
- [shuding/nextra](https://github.com/shuding/nextra) ([nextra-theme-docs@2.11.0](https://github.com/shuding/nextra/releases/tag/nextra-theme-docs%402.11.0), 2 days ago) - Simple, powerful and flexible site generation framework with everything you love from Next.js.
- [tonightpass/kitchen](https://github.com/tonightpass/kitchen) ([@tonightpass/kitchen@1.8.1](https://github.com/tonightpass/kitchen/releases/tag/%40tonightpass/kitchen%401.8.1), 6 days ago) - @tonightpass delicious React @styled-components (currently under construction...)
- [vercel/turbo](https://github.com/vercel/turbo) ([v1.10.13-canary.0](https://github.com/vercel/turbo/releases/tag/v1.10.13-canary.0), 1 week ago) - Incremental bundler and build system optimized for JavaScript and TypeScript, written in Rust – including Turbopack and Turborepo.
...
- [alii/searchy](https://github.com/alii/searchy) ([v0.2.2](https://github.com/alii/searchy/releases/tag/v0.2.2), 1 week ago) - Cloudflare &#43; Google = supercharged web surfing
- [AntoineKM/antoine](https://github.com/AntoineKM/antoine) ([eslint-config-antoine@1.0.7](https://github.com/AntoineKM/antoine/releases/tag/eslint-config-antoine%401.0.7), 3 weeks ago) - cool tools to code like me.
...
- [fix: update typo of `resources` folder](https://github.com/esx-framework/esx-documentation/pull/94) on [esx-framework/esx-documentation](https://github.com/esx-framework/esx-documentation) (3 months ago)
