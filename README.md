...
- [vercel/turbo](https://github.com/vercel/turbo) ([v1.10.15-canary.0](https://github.com/vercel/turbo/releases/tag/v1.10.15-canary.0), today) - Incremental bundler and build system optimized for JavaScript and TypeScript, written in Rust – including Turbopack and Turborepo.
...
- [TrevorSundberg/puppeteer-in-electron](https://github.com/TrevorSundberg/puppeteer-in-electron) - Use puppeteer to test and control your electron application. (today)
