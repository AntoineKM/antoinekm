...
- [AntoineKM/staging](https://github.com/AntoineKM/staging) ([staging-next@0.0.3](https://github.com/AntoineKM/staging/releases/tag/staging-next%400.0.3), today) - Password protect your staging &amp; preview deployments. Free open-source alternative to Vercel &amp; Netlify password protection - Next.js, Nuxt, Express
- [AntoineKM/dixt](https://github.com/AntoineKM/dixt) ([dixt@2.1.11](https://github.com/AntoineKM/dixt/releases/tag/dixt%402.1.11), 2 days ago) - The Discord Framework
...
- [Fredolx/open-tv](https://github.com/Fredolx/open-tv) - Ultra-fast, simple and powerful cross-platform IPTV app (1 month ago)
